...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        p1 = Plant(name='milkweed', genus_species='Asclepias syriaca', growing_zone='3-9', image='https://cdn.pixabay.com/photo/2012/02/28/15/37/butterfly-18313_1280.jpg', user_id=rc(users).id)
        plants.append(p1)

        p2 = Plant(name='hyssop', genus_species='Hyssopus officinalis', growing_zone='3-9', image='https://cdn.pixabay.com/photo/2021/08/18/17/58/fritillary-butterfly-6556180_1280.jpg', user_id=rc(users).id)
        plants.append(p2)

        p3 = Plant(name='asters', genus_species='Aster amellus', growing_zone='3-8', image='https://cdn.pixabay.com/photo/2012/02/26/10/54/garden-17057_1280.jpg', user_id=rc(users).id)
        plants.append(p3)

        p4 = Plant(name='liatris', genus_species='Liatris spicata', growing_zone='3-8', image='https://cdn.pixabay.com/photo/2018/05/23/11/19/liatris-3423800_1280.jpg', user_id=rc(users).id)
        plants.append(p4)
